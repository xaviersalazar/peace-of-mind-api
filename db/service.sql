...
(15, 'Breast Enhancement', 'The specially designed vacuum pump can improve size and shape or breast safely and comfortably. The vacuum pulls fat toward the breast tissue, permeating the breast cells, leaving them fuller.', 'breast-buttlift-breast-enhance.jpg', 3),
(16, 'Butt Lifting', 'Cupping is all the rage for lifting and enhancing the butt. 2 sessions per week for 10 weeks, and the results will be noticeable.', 'breast-buttlift-butt-lift.jpg', 3),
(17, 'Fat Eliminator Sculpting', 'Safely and effectively improve the shape of the belly, thighs, butt, and back by using point percussion therapy with the scrub cup to help eliminate fat on the body. Cupping has been used for overall health by the negative pressure and suction causing the nervous system to sedate, treating high blood pressure, relieving pain in the back and neck, loosening stiff muscles, and treating anxiety, fatigue, and even rheumatism.', 'breast-buttlift-fat-sculpt.jpg', 3),
...
(39, 'Microdermabrasion Facial', 'A non-invasive procedure that uses tiny crystals or other exfoliating surfaces to help remove the superficial layer of dead skin cells.', 'facial-microderm-addon.jpg', 6),
...
(100, 'Color Correction', NULL, 'haircolor-correction.jpg', 18),
...
(118, 'Highlights', NULL, 'highlight-highlights.jpg', 19),
(119, 'Partial Highlights', NULL, 'highlight-partial-highlights.jpg', 19),
...
(132, 'Silk Press', NULL, 'hair-treatments-silk-press.jpg', 20),
...
(139, 'Pedi Bowl', 'Unlike most nail salons where you dip your feet in the same contaminated foot bath, we use fresh clean water with fresh herbs and aromatherapy oils, ensuring you never get a foot fungus. Using tea tree, coconut milk, and lavender to help soften the feet. We clean up the cuticle, file, and finish with a vegan friendly all organic non-toxic, free of DBP, formaldehyde, formaldehyde resin, and non GMO nail lacquer.', 'pedi-bowl.jpg', 22),
