...
(4, 'Dry Brushing', 'Adding a dry brush to your massage helps by exfoliating & stimulating the lymphatic system and circulation starts at the feet and works it way up including under arms. Proven to help with cellulite, removes dead skin cells, and aids in decreasing bloating. Great with aroma therapy to accelerate blood flow.', 2),
(5, 'Massage Flame', 'Experience the Flame an irresistible Hot Oil Massage. 100% Natural Multi-Sensory Experience. Lavish blend of exotic palm kernel oil, soy oil, Shea butter, jojoba oil, Vitamin E, organic coconut oil, and essential oils. It leaves the skin silky smooth and irresistibly scented.', 2),
(6, 'Herbal Infused Heat Packs', 'This treatment covers the entire torso for total body warmth sending you in to a new world of Bliss and Deep Relaxation. Lavender, valerian root, white willow, chamomile, rosemary, peppermint, spearmint, hops, yellow dock, lemongrass, cinnamon, yarrow, premium flax seeds. Ideal for clients that suffer from arthritis, back pain, stress relief and many other common ailments.', 2),
(7, 'Ice Massage', 'A great way to apply ice therapy to a sports injury. It has many benefits over ice bags, and is especially useful for injuries like shin splints, plantar fasciitis, and hip flexor strains. Benefits for a better penetration of the cooling effects of ice therapy when compared to traditional ice bags. It also uses the effects of massage to mobilize the soft tissue. When applied to superficial muscles, it can help to decrease inflammation and to reduce pain.', 2),
(8, 'Lash Extensions', 'Coming Soon', 2),
(9, 'Rain Drop Therapy', 'Kills Bacteria Pathogens, Reduces Inflammation, Supports the Immune System, Eases Respiratory Discomfort, Lifts the Spirit, Relaxes Muscles, Curbs Digestive Upset, Relieves Body & Joint Pain, Balances Energy, Restores Calmness, Increases Concentration', 2),
(10, 'CBD Infused Massage', 'CBD oil reduces inflammation, is a potent pain reliever. It alleviates stress and anxiety, may help with skin cancer and other skin stresses. Also helps clear toxins'' ultimate skin protector and moisturizer.', 2),
(11, 'Paraffin Wax Treatment', 'The benefits of paraffin wax are endless, used in ancient times Romans would pour hot waxes on the body in preparation for a massage. The French embraced paraffin wax therapy by spreading it on their wounds to accelerate healing. Paraffin wax is helpful with Arthritis, Bursitis, Eczema, Fibromyaxlia, Fibrosis, Inflammation, Muscle Spasm, Psoriasis, Scar Tissue, Stiff Joints, and Tendonitis.', 2),
(12, 'LightStim Therapy', 'Temporarily relieves arthritic pain, muscle and joint pain, and stiffness. Increases blood circulation, speed healing, and diminishes bruising. Also is a natural solution to help achieve clear and healthy skin by treating existing blemishes, minimizing breakouts, and recapturing your radiant glow. It is the most effective and affordable technology for achieving healthy and youthful skin.', 2),
(13, 'Lava Shells', 'When filled with the patented self-heating technology of Lava Gel, Lava Shells heat for up to 45-minutes, depending on the method of application, giving you the same heat as a full hot stone massage with just two shells – no electricity of equipment needed.', 2),
(14, 'Glacier Shells', 'Enhancement to any facial to reduces dark circles & puffiness around the eyes, help to suppress acne flare-ups, help to firm and tighten skin prior to a makeup application, increase circulation, diminish the appearance of wrinkles, suppress hair growth, help to rejuvenate the skin and reduce skin inflammation.', 2),
(15, 'Breast Enhancement', 'The specially designed vacuum pump can improve size and shape or breast safely and comfortably. The vacuum pulls fat toward the breast tissue, permeating the breast cells, leaving them fuller.', 3),
(16, 'Butt Lifting', 'Cupping is all the rage for lifting and enhancing the butt. 2 sessions per week for 10 weeks, and the results will be noticeable.', 3),
...
(18, 'Coffee & Cocoa Treatment', 'These natural oils are a purifying dose of detoxification; they also provide illuminating moisture reintroducing the glow to overly dry skin.', 2),
(19, 'Couples #1', 'Swedish Massage with Aromatherapy. Performed in a serene setting, the duet massage encourages unity, connection and collective calm. Ease stress and unwind as two therapists perform side-by-side Swedish Massages that help the two of you relax. With a Cooling Mint Eye mask. Including reflexology and a scalp massage. Breathing treatment & Herbal infused hot towel with a foot detox herbal spray.', 5),
(20, 'Couples #2', 'Hot Stones & Aromatherapy. Performed in a serene setting, the duet massage encourages unity, connection and collective calm. Ease stress and unwind as two therapists perform side-by-side Swedish Massages that help the two of you relax.With a Cooling Mint Eye mask. Including reflexology and a scalp massage. Breathing treatment, with a Herbal infused detox spray.', 5),
(21, 'Couples #3', 'Deep Tissue Massage, Hot Stone, Aromatherapy & Indian Scalp Massage. Performed in a serene setting, the duet massage encourages unity, connection and collective calm. Ease stress and unwind as two therapists perform side-by-side Deep Tissue Massages that help the two of you relax.With a Cooling Eye mask. With our own Herbal breathing treatment and herbal foot detox spray.', 5),
(22, 'Pampered Party Packet', '1 Hour and 35 Minutes of Swedish Massage, Hot Stones, Reflexology, Aromatherapy, and a Pressure Point Release Rain Drop Facial and Pearl Mask.', 5),
(23, 'Silk Spine Massage', 'Gliding around spine very gently pushing tired knotted up muscles away from the spine gently caressing the nerves in the surrounding are to relive and relax your central nervous system. Allowing your central nervous system to flow freely and unblocked. Better sleep and fewer headaches along with lowered anxiety. Overall mood improvement!', 5),
(24, 'Cleopatra''s Dead Sea', 'Purifies hydrates and restores elasticity adding moisture to skin for a vibrant complexion. Along with making the skin soft supple and smoother looking. It reaches deep in to the pores, removing grime which slow down the nourishing process. Chamomile, jojoba oil, Maris salt, vitamin B5, Aloe Vera, fruit oil, Vitamin E. With an added Jade Stone Massage to cool down the skin and give it that added natural glow.', 6),
(25, 'Custom Back Facial', 'Purify your neck, shoulders and back, with a custom organic blend made moments before your treatment.', 6),
(26, 'Don''t Crease Me Poppy Seed', 'Lemons and poppy seed facial wrinkles and fine line reducer. It exfoliates and polishes leaving skin radiant! With all organic products featuring lemon, poppy seeds ,coconut oil rosemary nutmeg and vitamin E and B-5 almond oil , pecan shells, grape fruit and clove.', 6),
...
(29, 'Goodbye Pore Me', 'Minimize pores and wipes out dead surface from your face. Rare Amazonian white clay, Herbal Moisturizer, cinnamon Bark, Ginger Root, Apricot Kernel Oil, Vitamin E, Avocado Oil Sweet Almond Oil.', 6),
(30, 'Honey Bee Pollen My Feathers', 'This mask works against Acne and eczema. Perfect for anti-aging absorbs free Radicals.', 6),
...
(62, 'Barefoot Massage: Deepest Deep Tissue Massage Possible', 'Reduces Chronic Pain. This Deep Tissue massage works further into the fascia. It also will release trigger points and connective tissues. It is a slow and more forceful in the application. Not only adds more pressure but it also adds compression. And it throws myofascial stretching into the mix. Compression massage squeezes the entire body from above and below. It also affects internal organs. It is a soft structural integration that realigns the body. Skeletal adjustments often occur during a session. It also has myofascial benefits that relax and stretch contracted muscles. This unique modality combines three therapies into one. It also Improves Flexibility, No Residual Soreness, Reduces Stress, Effects Last Longer.', 1),
(63, '4 Handed Massage', 'A therapeutic, duet massage is performed by two therapists whose coordinated movements induce relaxation and ease tension. To promote self balance and clarity. A soothing scalp massage and reflexology will leave you with a sense of calm and well-being. The organic,balancing massage oil used during treatment soothes the senses and nourishes the skin. Emerge renewed, refreshed and relaxed.', 1),
(64, 'Oxygey Session', 'A high purity way to get oxygen for recreation and relaxation. Indulge in Aroma O2 oxygen giving you a mild safe euphoric feeling. Oxygen is nutrient for the brain, The brain of an adult accounts for 2 to 3 percent of the whole body in terms of weight but consumes 20% of oxygen absorbed into the body. Brain cells need 200 liters of oxygen a day for proper operation.', 11),
(65, 'Foot Soak', 'Is the ionic foot bath machine right for me? With the increase in the number of chemicals and hazardous materials introduced in the last few decades, there has been a dramatic increase in incidences of auto-immune disease, allergies and common infections. Although people are living longer, we face new types of diseases and infections as we become immune to older ones. There are tens of thousands of chemicals in use today and more than a forth of these are known to be toxic and nothing is known about their interactive effects. Body fat has been tested that contains residue of hundreds of chemicals. Metals, such as mercury and cadmium are everywhere and impossible to avoid. Lead can block red blood cell formation. Chemicals can act as toxins that can block receptor sites on cells, and cause changes in calcium homeostasis selectively killing cells, and alter expression of gene products. Metals and chemical toxins weaken the immune system and cause increased vulnerability to virus, bacterial fungal and parasitic infections. In an attempt to detoxify these substances, our bowels, kidneys and liver are being overloaded. Our eliminative channels have become blocked or dysfunctional, because, in conjunction with these synthetic chemicals, and the western diet that is so acid forming and de-vitalized. ', 12),
(66, 'Honey Relax', 'A relaxation ritual richly crafted blend of sugar crystals, nutrient-rich antioxidants and essential oils creating a comprehensive exfoliation treatment. Spearmint leaf, organic , Lime, Lavender and Sandalwood are included in the 50 Minute Scrub.', 13),
(67, 'Polish Me Perfect', 'Raw Sugar Cane granules produce glycolic acid, help refine pores, boost collagen and elastin, bind moisture and brighten skin all over along with reducing the sight of cellulite helping you become fully balanced using Grape Seed Oil,Coffee, Fresh Coconut , Geranium, Rosemary and Lavender.', 13),
(68, 'Weight Loss Body Wraps', 'After the mixture is brushed on the body you are then wrapped in plastic wrap and thermal blanket. Clay body wraps absorb and draw out toxins in skin, bentonite clay particles hold a negative electrical charge, while toxins have a positive charge. The negatively charged particles draw the toxins out of skin through the pores. The theory goes back centuries, and it has been proven that Cleopatra used clay poultices as skin treatments.', 13),
(69, 'Arm Waxing', NULL, 14),
(70, 'Back Waxing', NULL, 14),
(71, 'Bikini Waxing', NULL, 14),
(72, 'Brazilian Bikini Waxing', NULL, 14),
(73, 'Face Waxing', NULL, 14),
(74, 'Full Leg Waxing', NULL, 14),
(75, 'Chest Waxing', NULL, 14),
(76, 'Chin Waxing', NULL, 14),
(77, 'Extended Bikini Waxing', NULL, 14),
(78, 'Eyebrow Waxing', NULL, 14),
(79, 'Lip Waxing', NULL, 14),
(80, 'Lower Leg Waxing', NULL, 14),
(81, 'Underarm Waxing', NULL, 14),
(82, 'Upper Leg Waxing', NULL, 14),
(83, 'Eyebrow Tint', NULL, 15),
(84, 'Eyelash Tint', NULL, 15),
(85, 'Refill', NULL, 15),
(86, 'Eyelash Perm', NULL, 15),
(87, 'Eyelash Extensions', NULL, 15),
(88, 'Eyelash Extensions with Volume', NULL, 15),
(89, 'Blow Dry', NULL, 16),
(90, 'Up-do''s', 'Braiding, up-styles and curls', 16),
(91, 'Ironworks', NULL, 16),
(92, 'French Braid', NULL, 16),
(93, 'Dutch Braid', NULL, 16),
(94, 'Haircut & Blow Dry', NULL, 17),
(95, 'Kid''s Haircut (12 & under)', NULL, 17),
(96, 'Dry Cut', NULL, 17),
(97, 'Bangs', NULL, 17),
(98, 'Glossing', 'Performed following chemical service to add intense shine', 18),
(99, 'Temporary Color Rinse', NULL, 18),
(100, 'Color Correction', NULL, 18),
(101, 'All Over Color', NULL, 18),
(102, 'All Over Color with Shampoo & Condition (Travel Size)', NULL, 18),
(103, 'All Over Bleach', NULL, 18),
(104, 'Bleach Root Touch-Up', NULL, 18),
(105, 'Root Touch-Up', NULL, 18),
(106, 'Chemical Services', NULL, 18),
(107, 'Hair Extensions Install', 'Prices vary, contact us for a consultation ', 30),
(108, 'Foil', 'The ultimate in hair coloring, providing smoothness, protection and brilliant shine for long-lasting color', 19),
(109, 'Foil with Haircut', NULL, 19),
(110, 'Partial Foil', 'Up to 12 foils', 19),
(111, 'Partial Foil with Haircut', NULL, 19),
(112, 'Accent Foil', 'Up to 4 foils', 19),
(113, 'Dimensional Color', 'Two or more colors to create a unique, multi-dimensional look', 19),
(114, 'Ombre Hair', 'Coloring technique where a gradual fading of color from dark to light, or vice-versa, is achieved. Additional cost for add-on color', 19),
(115, 'Ombre with Haircut', NULL, 19),
(116, 'Balayage Freehand', 'Technique of applying highlights, or lowlights, with select pieces of hair receiving the color enhancement', 19),
(117, 'Balayage with Haircut', NULL, 19),
(118, 'Highlights', NULL, 19),
(119, 'Partial Highlights', NULL, 19),
(120, 'Keep It Curl Organic Color Systems Treatment', NULL, 20),
(121, 'Aqua Boost Organic Treatment', NULL, 20),
(122, 'Power Build Treatment', NULL, 20),
(123, 'Organic Color Systems Smooth+ Treatment', NULL, 20),
(124, 'Dry Scalp & Dandruff', 'Organic Custom Blend & Scalp Tonic', 20),
(125, 'Dry Scalp', 'Dry Scalp Tonic', 20),
(126, 'Organic Color Systems Intensive Clarifying', NULL, 20),
(127, 'Organic Color Systems Brazilian Blowout Treatment', NULL, 20),
(128, 'Peace Of Mind Scalp Treatment', NULL, 20),
(129, 'Rainbow Chakra Treatment', NULL, 20),
(130, 'Charcoal Treatment', NULL, 20),
(131, 'Organic Lice Removal Treatment', 'Must book 2 weeks in advance', 20),
(132, 'Silk Press', NULL, 20),
(133, 'Loc Maintenance', NULL, 21),
(134, 'Loc Styling', NULL, 21),
(135, 'Hot Towel Mani', 'Wrapping hands in herbal & aromatherapy infused towels to insure full relaxation and deep moisturization. We clean up the cuticle, file, and finish with a vegan friendly all organic non-toxic, free of DBP, formaldehyde, formaldehyde resin, and non GMO nail lacquer.', 22),
(136, 'Mani Bowl', 'Using clean water, fresh herbs and aromatherapy oils. We clean up the cuticle, file, and finish with a vegan friendly all organic non-toxic, free of DBP, formaldehyde, formaldehyde resin, and non GMO nail lacquer.', 22),
(137, 'CBD Oil Add On', NULL, 22),
(138, 'Hot Towel Pedi', 'Unlike most nail salons where you dip your feet in the same contaminated foot bath bowl, we use fresh clean hot towels that are infused with herbs & aromatherapy oils, ensuring you never get a foot fungus. Using hot stones to massage tired aching feet, an all-natural organic foot and leg scrub made in house and a revitalizing foot massage. We clean up the cuticle, file, and finish with a vegan friendly organic non-toxic, free of DBP, formaldehyde, formaldehyde resin, and non GMO nail lacquer.', 22),
...
(140, 'Everyday', NULL, 23),
(141, 'Bridal', NULL, 23),
(142, 'Haircut', NULL, 24),
(143, 'Gray Blending', NULL, 24),
(144, 'Signature Experience', 'Includes scalp massage, hot towel, hair cut, and facial hair trim', 24),
(145, 'Beard Trimmings', NULL, 24),
(146, 'Shampoo & Diffuse', NULL, 25),
(147, 'Basic Corn Row', NULL, 25),
(148, 'Corn Row with Design', NULL, 25),
(149, 'Bantu Knots', NULL, 25),
(150, 'Basic Wave', NULL, 26),
(151, 'Basic Wave with Haircut', NULL, 26),
(152, 'Specialty Wave', NULL, 26),
(153, 'Specialty with Haircut', NULL, 26),
(154, 'Press & Curl', NULL, 27),
(155, 'Shampoo Services with Two-Stand Twist', NULL, 27),
(156, 'Shampoo Services with Flat-Twist Set', NULL, 27),
(157, 'Single Twist Comb Twist', NULL, 27),
(158, 'Double Twist Two Strand', NULL, 27),
(159, 'Straw Set', NULL, 27),
(160, 'Rod Set', NULL, 27),
(161, 'Kinky Twist', NULL, 28),
(162, 'Rope Twist', NULL, 28),
(163, 'Micro Braids', NULL, 28),
(164, 'Organic Colors Systems Ultimate Blowout', NULL, 29),
(165, 'Organic Colors Systems Blowout with Haircut', NULL, 29),
...
(170, 'Venus Legacy', 'Venus Legacy is an advanced non-invasive medical device that effectively resolves challenging Face and body aesthetic needs, such as nonsurgical circumferential reduction, cellulite reduction, skin tightening, and wrinkle reduction. It decreases swelling and helps tighten the skin. We also advise all our patients receiving laser treatments that they too should improve the tightening of their skin. (We will have packets available when you purchase 6 youll get the 7th one free.)', 3),
(171, 'Apricot Cream Rogue', NULL, 31),
(172, 'Bisque Souffle Foundation', NULL, 31),
(173, 'Brightening Violet Powder', NULL, 31),
(174, 'Crimson Cream Rogue', NULL, 31),
(175, 'Dark Cashmere Powder Compact', NULL, 31),
(176, 'Honey Souffle Foundation', NULL, 31),
(177, 'Light Cashmere Powder Compact', NULL, 31),
(178, 'Medium Beige Souffle Foundation', NULL, 31),
(179, 'Medium Cashmere Powder Compact', NULL, 31),
(180, 'Porcelain Cashmere Powder Compact', NULL, 31),
(181, 'Cashmere Powder Dark Refill', NULL, 31),
(182, 'Cashmere Powder Light Refill', NULL, 31),
(183, 'Cashmere Powder Medium Refill', NULL, 31),
(184, 'Cashmere Powder Porcelain Refill', NULL, 31),
(185, 'Cashmere Powder Violet Refill', NULL, 31),
(186, 'True Beige Souffle Foundation', NULL, 31),
(187, 'Violet Brightening Powder Compact', NULL, 31),
(188, 'Yellow Cameo Souffle Foundation', NULL, 31),
(189, 'Black Mascara', NULL, 32),
(190, 'Brown Cake Mascara', NULL, 32),
(191, 'Black Cake Mascara', NULL, 32),
(192, 'Besame Red', NULL, 33),
(193, 'Noir Red', NULL, 33),
(194, 'Tango Red', NULL, 33),
(195, 'Carmine', NULL, 33),
(196, 'Merlot', NULL, 33),
(197, 'Cherry Red', NULL, 33),
(198, 'American Beauty', NULL, 33),
(199, 'Red Velvet', NULL, 33),
(200, 'Exotic Pink', NULL, 33),
(201, 'Red Hot Red', NULL, 33),
(202, 'Portrait Pink', NULL, 33),
(203, 'Debutante Pink', NULL, 33),
(204, 'Dusty Rose', NULL, 33),
(205, 'Chocolate Kiss', NULL, 33);